...
cd(initialize_script_path(1:end-44));
...
increment_waypoint_distance = [0.10 0.15 0.18 0.20 0.25 0.30 0.35 0.40];
...
obstacles{1} = box_obstacle_zonotope('center', [0.63016; 0.40426; 0.47],...
...
for i = 1:length(increment_waypoint_distance)
    % run loop
    ...
    P = uarmtd_planner('verbose', verbosity, ...
                       ...
                       'increment_waypoint_distance', increment_waypoint_distance(i),...
                       'use_SLP',use_SLP,...
