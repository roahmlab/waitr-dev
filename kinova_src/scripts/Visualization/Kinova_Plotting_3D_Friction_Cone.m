...
% start indexing for figure numbering
fig_num = 1;
...
% load .mat file of simulation workspace
sim_result_file = 'FrictionConePlottingTrial.mat';
sim_result = load(sim_result_file);

% extract the relevant data structures
A = sim_result.A;
W = sim_result.W;
S = sim_result.S;
P = sim_result.P;
...
% load robot and parameters of robot
robot = A.robot;
params = A.params;
% can also directly specify robot and load parameters
...
% can also directly specify goal type and goal radius
...
transmision_inertia = A.transmision_inertia;
% Kinova values: [8.02999999999999936 11.99620246153036440 9.00254278617515169 11.58064393167063599 8.46650409179141228 8.85370693737424297 8.85873036646853151]; 
...
plan_index = 1;
% start index of the planning iteration. Note that 1 corresponds to first
% planning iteration, needs to match the plan_index though.
traj_index = 1;
