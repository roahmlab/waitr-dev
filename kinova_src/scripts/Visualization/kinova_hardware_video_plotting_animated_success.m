...
%     plot(time(1:i),pos_err(1:i,:))
%     % upper bound position
%     plot([1 time(end)],[0.0176 0.0176],'--k')
...
%     plot(time(1:i),vel_err(1:i,:))
%     % upper bound velocity
%     plot([1 time(end)],[0.1411 0.1411],'--k')
...
%     ylabel('Velocity Error (rad)')
%     xlabel('Time (s)')
% 
%     set(gca,'FontSize',fontsize)
% 
%     exportgraphics(gca,'ErrorPlot.avi','Resolution',300,'BackgroundColor','none')
