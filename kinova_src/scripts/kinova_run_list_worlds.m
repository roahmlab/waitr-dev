...
file_location = '../results/rtd-force/dur2s_largeStateBuffer_noObs_03052023_v2_single' ;
...
list_of_worlds = [2	7 10 13	14 15 20 23 35 37 40 44 45 48 50 51 55 56 58 59 60 61 64 69 70 71 74 76 78 79 85 87 88 89 91 94 95 98];
...
tic
for idx = 11:length(list_of_worlds) % length(world_file_list)
    clc; 
    fprintf("THIS IS WORLD %d\n\n", list_of_worlds(idx));

    % read world CSV to get start and goal, populate obstacles:
    world_filename = world_file_list(list_of_worlds(idx)).name;
    ...
    P = uarmtd_planner_wrapper('verbose', verbosity, ...
